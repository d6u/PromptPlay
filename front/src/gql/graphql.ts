...
export type CreatePlaceholderUserAndExampleSpaceResult = {
  ...
  /** @deprecated placeholderUserToken have been moved to session storage */
  placeholderClientToken?: Maybe<Scalars['ID']['output']>;
  space: Space;
};
...
export type HeaderAccountDetailQueryQuery = { __typename?: 'Query', isLoggedIn: boolean, isPlaceholderUserTokenInvalid: boolean, user?: { __typename?: 'User', id: any, email?: string | null, profilePictureUrl?: string | null } | null };
...
export type CreatePlaceholderUserAndExampleSpaceMutationMutation = { __typename?: 'Mutation', result: { __typename?: 'CreatePlaceholderUserAndExampleSpaceResult', space: { __typename?: 'Space', id: string } } };
...
export type RootRouteLoaderQueryQuery = { __typename?: 'Query', isLoggedIn: boolean, isPlaceholderUserTokenInvalid: boolean, user?: { __typename?: 'User', id: any, email?: string | null } | null };

export type MergePlaceholderUserIntoLoggedInUserMutationMutationVariables = Exact<{
  placeholderUserToken: Scalars['String']['input'];
}>;


export type MergePlaceholderUserIntoLoggedInUserMutationMutation = { __typename?: 'Mutation', mergePlaceholderUserWithLoggedInUser?: { __typename?: 'User', id: any, spaces: Array<{ __typename?: 'Space', id: string }> } | null };
...
export const MergePlaceholderUserIntoLoggedInUserMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MergePlaceholderUserIntoLoggedInUserMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"placeholderUserToken"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mergePlaceholderUserWithLoggedInUser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"placeholderUserToken"},"value":{"kind":"Variable","name":{"kind":"Name","value":"placeholderUserToken"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"spaces"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<MergePlaceholderUserIntoLoggedInUserMutationMutation, MergePlaceholderUserIntoLoggedInUserMutationMutationVariables>;