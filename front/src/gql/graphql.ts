...
export type SpaceFlowQueryQuery = { __typename?: 'Query', result?: { __typename?: 'QuerySpaceResult', space: { __typename?: 'Space', id: string, name: string, contentVersion: ContentVersion, flowContent?: string | null } } | null };
