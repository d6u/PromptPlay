...
export type SpaceContentVersionQueryQuery = { __typename?: 'Query', space?: { __typename?: 'QuerySpaceResult', isReadOnly: boolean, space: { __typename?: 'Space', id: string, canvasDataSchemaVersion: ContentVersion } } | null };
...
export type UpdateSpaceContentV3MutationMutation = { __typename?: 'Mutation', updateSpace?: { __typename?: 'Space', id: string, canvasData?: string | null } | null };
...
export type SpaceFlowQueryQuery = { __typename?: 'Query', result?: { __typename?: 'QuerySpaceResult', space: { __typename?: 'Space', id: string, name: string, canvasDataSchemaVersion: ContentVersion, canvasData?: string | null } } | null };
...
export const UpdateSpaceContentV3MutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateSpaceContentV3Mutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"spaceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"canvasData"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateSpace"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"spaceId"}}},{"kind":"Argument","name":{"kind":"Name","value":"contentVersion"},"value":{"kind":"EnumValue","value":"v3"}},{"kind":"Argument","name":{"kind":"Name","value":"canvasDataV4"},"value":{"kind":"Variable","name":{"kind":"Name","value":"canvasData"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"canvasData"}}]}}]}}]} as unknown as DocumentNode<UpdateSpaceContentV3MutationMutation, UpdateSpaceContentV3MutationMutationVariables>;
